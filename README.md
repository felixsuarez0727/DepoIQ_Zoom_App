#DepoIQ - Zoom App Solution

**Power up your Zoom meetings with smart DepoIQ integrations**

This project uses Node.js + Express to build a custom app for the Zoom Marketplace, designed to improve meeting productivity with specialized tools for professional teams.

## 🔍 Project Vision

DepoIQ is a solution that enables:
- Real-time data integration during meetings
- Advanced collaborative tools
- Customization of specific workflows
- Interactive dashboard for participants

## 🛠 Technical Prerequisites

1. [Node.js v16+](https://nodejs.org/en/)
2. [Ngrok](https://ngrok.com/) (For local development)
3. Zoom Enterprise or Business account
4. Developer credentials:
- Client ID
- Client Secret
- Redirect URI (Configured in [Zoom Dev Console](https://developers.zoom.us/))
...
git clone git@github.com:felixsuarez0727/DepoIQ_Zoom_App.git
